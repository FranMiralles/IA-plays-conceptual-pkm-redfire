...
if __name__ == "__main__":
    ...
    individual1 = [[7, 16, 19, 13, 25, 21, 23, 35, 43, 63, 52, 69, 129, 50, 27, 56, 41, 37, 58, 84, 92, 48, 79, 43, 43, 128, 19, 19, 72, 116, 54, 86, 88, 125, 118, 74], [[19, 16, 7, 25, 13], [7, 13, 25, 16, 19], [19, 16, 7, 25, 21, 
23], [43, 7, 16, 19, 25, 35], [129, 16, 13, 50, 52, 21], [52, 35, 7, 25, 21, 63], [129, 21, 41, 50, 19, 13], [58, 37, 13, 56, 63, 35], [56, 25, 58, 50, 37, 52], [25, 58, 37, 52, 84, 129], [92, 129, 50, 16, 19, 56], [92, 37, 50, 56, 27, 63], [129, 79, 84, 13, 48, 56], [19, 58, 7, 84, 86, 129], [63, 54, 16, 50, 116, 41], [129, 58, 52, 86, 88, 63], [72, 56, 52, 116, 27, 63], [63, 27, 56, 52, 72, 116], [63, 27, 116, 52, 72, 56], [27, 72, 116, 63, 56, 52], [72, 52, 56, 63, 27, 116]]] 
    #individual = crossover_individuals(individual1, individual2)
    individual1 = generate_individual()
    print(individual1)
    individuo_ejemplo = [[7, 16, 21, 19, 10, 32, 23, 74, 63, 43, 52, 69, 96, 50, 27, 56, 95, 37, 58, 84, 92, 48, 129, None, None, 54, None, None, 72, 116, 79, 86, 109, 81, 60, 66], [[21, 16, 19, 10, 7], [7, 16, 21, 10, 19], [32, 19, 16, 7, 10, 74], [43, 10, 32, 63, 19, 23], [21, 63, 10, 96, 7, 69], [74, 32, 19, 96, 7, 52], [74, 21, 95, 16, 52, 32], [58, 19, 74, 69, 27, 92], [56, 63, 52, 10, 50, 84], [129, 63, 19, 48, 7, 54], [92, 27, 37, 16, 69, 56], [92, 7, 21, 50, 69, 95], [96, 27, 92, 50, 69, 52], [72, 50, 79, 19, 81, 69], [63, 58, 92, 48, 16, 109], [129, 19, 109, 10, 116, 74], [72, 56, 54, 52, 92, 32], [92, 52, 72, 32, 56, 54], [32, 72, 56, 54, 92, 52], [32, 54, 56, 72, 52, 92], [56, 52, 72, 32, 92, 54]]]
    (feasibility, fitness_value, entire_logs) = calculate_fitness(individuo_ejemplo, dataset=dataset, verbose=True)
    for log in entire_logs:
        print(log, "\n")
        
    window = App(individuo_ejemplo, feasibility, fitness_value, entire_logs)
    window.show()
    sys.exit(app.exec_())